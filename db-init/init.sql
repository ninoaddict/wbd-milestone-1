...
insert into company_detail (user_id, lokasi, about) values (2, 'Santo Domingo', 'nulla nunc purus phasellus in felis donec semper sapien a libero nam dui proin leo odio porttitor');
insert into company_detail (user_id, lokasi, about) values (11, 'San Carlos', 'sed sagittis nam congue risus semper porta volutpat quam pede lobortis ligula sit amet eleifend pede libero quis orci');
insert into company_detail (user_id, lokasi, about) values (23, 'Boulogne-sur-Mer', 'nisl duis bibendum felis sed interdum venenatis turpis enim blandit mi in porttitor pede justo');
insert into company_detail (user_id, lokasi, about) values (25, 'Meilin', 'ante vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere');
insert into company_detail (user_id, lokasi, about) values (33, 'Phumĭ Véal Srê', 'vel nulla eget eros elementum pellentesque quisque porta volutpat erat quisque erat eros viverra eget congue eget semper');
insert into company_detail (user_id, lokasi, about) values (40, 'Starokorsunskaya', 'fringilla rhoncus mauris enim leo rhoncus sed vestibulum sit amet cursus id turpis integer aliquet massa');
insert into company_detail (user_id, lokasi, about) values (44, 'Rukaj', 'risus semper porta volutpat quam pede lobortis ligula sit amet eleifend pede libero quis orci nullam molestie');
insert into company_detail (user_id, lokasi, about) values (45, 'Sindangsari', 'erat volutpat in congue etiam justo etiam pretium iaculis justo in hac habitasse platea dictumst etiam faucibus cursus urna ut');
insert into company_detail (user_id, lokasi, about) values (52, 'Anaráchi', 'ante vivamus tortor duis mattis egestas metus aenean fermentum donec ut mauris eget massa tempor convallis nulla');
insert into company_detail (user_id, lokasi, about) values (53, 'Jimsar', 'ut rhoncus aliquet pulvinar sed nisl nunc rhoncus dui vel sem sed sagittis nam congue risus semper porta volutpat');
insert into company_detail (user_id, lokasi, about) values (56, 'Maebashi-shi', 'at feugiat non pretium quis lectus suspendisse potenti in eleifend');
insert into company_detail (user_id, lokasi, about) values (59, 'Wangping', 'ipsum dolor sit amet consectetuer adipiscing elit proin interdum mauris non');
insert into company_detail (user_id, lokasi, about) values (60, 'Guogan', 'ante vel ipsum praesent blandit lacinia erat vestibulum sed magna at nunc commodo placerat praesent blandit nam nulla integer pede');
insert into company_detail (user_id, lokasi, about) values (62, 'Colón', 'potenti cras in purus eu magna vulputate luctus cum sociis natoque');
insert into company_detail (user_id, lokasi, about) values (71, 'Tenancingo', 'semper sapien a libero nam dui proin leo odio porttitor id consequat in consequat ut nulla sed');
insert into company_detail (user_id, lokasi, about) values (86, 'Velikiye Luki', 'ultrices erat tortor sollicitudin mi sit amet lobortis sapien sapien non mi integer');
insert into company_detail (user_id, lokasi, about) values (98, 'Kaišiadorys', 'luctus tincidunt nulla mollis molestie lorem quisque ut erat curabitur gravida');
insert into company_detail (user_id, lokasi, about) values (99, 'Zhovti Vody', 'placerat praesent blandit nam nulla integer pede justo lacinia eget tincidunt eget tempus vel pede morbi porttitor');

insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (45, 'Project Manager', 'duis faucibus accumsan odio curabitur convallis duis consequat dui nec nisi volutpat', 'part-time', 'on-site', true);
...
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (33, 'Senior Cost Accountant', 'sed tristique in tempus sit amet sem fusce consequat nulla nisl nunc nisl', 'part-time', 'remote', true);
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (44, 'Legal Assistant', 'imperdiet nullam orci pede venenatis non sodales sed tincidunt eu felis fusce posuere felis', 'full-time', 'remote', true);
...
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (11, 'Executive Secretary', 'platea dictumst morbi vestibulum velit id pretium iaculis diam erat fermentum', 'full-time', 'hybrid', true);
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (45, 'Structural Engineer', 'lacinia aenean sit amet justo morbi ut odio cras mi pede malesuada in imperdiet et commodo', 'full-time', 'remote', true);
...
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (44, 'Staff Accountant IV', 'at ipsum ac tellus semper interdum mauris ullamcorper purus sit amet nulla quisque arcu libero', 'part-time', 'on-site', true);
...
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (33, 'Junior Executive', 'quisque ut erat curabitur gravida nisi at nibh in hac habitasse platea dictumst aliquam augue', 'internship', 'on-site', true);
...
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (45, 'Product Engineer', 'diam id ornare imperdiet sapien urna pretium nisl ut volutpat sapien', 'full-time', 'remote', true);
...
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (45, 'VP Product Management', 'duis faucibus accumsan odio curabitur convallis duis consequat dui nec nisi volutpat eleifend donec', 'part-time', 'hybrid', true);
insert into lowongan (company_id, posisi, deskripsi, jenis_pekerjaan, jenis_lokasi, is_open) values (33, 'VP Quality Control', 'in lectus pellentesque at nulla suspendisse potenti cras in purus eu', 'full-time', 'remote', true);
