...
insert into users (email, role, nama, password) values ('isanbroke1@biblegateway.com', 'company', 'Idaline Sanbroke', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('edakersa@yahoo.co.jp', 'company', 'Eadmund Dakers', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('mwilcherm@geocities.com', 'company', 'Marthena Wilcher', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('tharbishero@ifeng.com', 'company', 'Tammi Harbisher', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('cduddyw@army.mil', 'company', 'Cordie Duddy', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('rtrembath13@baidu.com', 'company', 'Russell Trembath', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('mgabotti17@omniture.com', 'company', 'Mendie Gabotti', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
insert into users (email, role, nama, password) values ('tnoulton18@bizjournals.com', 'company', 'Thorpe Noulton', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('vmechem1f@last.fm', 'company', 'Vivianne Mechem', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
insert into users (email, role, nama, password) values ('fbryan1g@cnn.com', 'company', 'Frank Bryan', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('katcherley1j@mail.ru', 'company', 'Kordula Atcherley', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('kgarm1m@stanford.edu', 'company', 'Kimble Garm', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
insert into users (email, role, nama, password) values ('dpitkeathley1n@adobe.com', 'company', 'Darice Pitkeathley', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('cbodman1p@phpbb.com', 'company', 'Clarabelle Bodman', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('arappa1y@amazonaws.com', 'company', 'Alastair Rappa', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('fmeddemmen2d@deliciousdays.com', 'company', 'Fanchon Meddemmen', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
...
insert into users (email, role, nama, password) values ('gmeace2p@mashable.com', 'company', 'Genvieve Meace', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
insert into users (email, role, nama, password) values ('ltearle2q@nsw.gov.au', 'company', 'Luce Tearle', '$2y$10$KCDl.0iEQL7kqyewJQI9J.qgIdOoB/tF7AIsD4vjyiqtwscczAAQa');
