...
<body>
            ...
            <form class="container-add-job" id="uploadForm" enctype="multipart/form-data">
                ...
                <div class="form-flex-structure">
                    <div class="form-structure">
                        ...
                        <input type="text" class="input-style" id="job-name" value="<?= $data['posisi']?>"/>
                    </div>
                    <div class="form-structure">
                ...
                <div class="form-flex-structure">
                    <div class="form-structure">
                        ...
                        <select id="location" class="input-style" value="<?= $data['jenis_lokasi']?>">
                            <option value="on-site" <?php if ($data['jenis_lokasi'] == "on-site") echo "selected"?>>On-Site</option>
                            <option value="hybrid" <?php if ($data['jenis_lokasi'] == "hybrid") echo "selected"?>>Hybrid</option>
                            <option value="remote" <?php if ($data['jenis_lokasi'] == "remote") echo "selected"?>>Remote</option>
                        </select>
                    </div>
                    <div class="form-structure">
                        <label for="job-type" class="input-name-style">Job Type</label>
                        <select id="job-type" class="input-style" value="<?= $data['jenis_pekerjaan']?>">
                            <option value="full-time" <?php if ($data['jenis_pekerjaan'] == "full-time") echo "selected"?>>Full-Time</option>
                            <option value="part-time" <?php if ($data['jenis_pekerjaan'] == "part-time") echo "selected"?>>Part-Time</option>
                            <option value="internship" <?php if ($data['jenis_pekerjaan'] == "internship") echo "selected"?>>Internship</option>
                        </select>
                    </div>
                </div>
                <div class="form-flex-structure">
  ...
  <script src="../../public/js/EditLowonganVacancy.js"></script>
